...
[![License](https://img.shields.io/badge/license-BSD-blue.svg)](https://github.com/admpub/sqlboiler/blob/master/LICENSE)
[![GoDoc](https://godoc.org/github.com/admpub/sqlboiler?status.svg)](https://godoc.org/github.com/admpub/sqlboiler)
...
```shell
go get -u -t github.com/admpub/sqlboiler

# Also install the driver of your choice, there exists pqsl, mysql, mssql
# These are separate binaries.
go get github.com/admpub/sqlboiler/drivers/sqlboiler-psql
```
...
Complete documentation is available at http://github.com/admpub/sqlboiler
...
import . "github.com/admpub/sqlboiler/queries/qm"
...
For a comprehensive ruleset for `Bind()` you can refer to our [godoc](https://godoc.org/github.com/admpub/sqlboiler/queries#Bind).
...
by using the
[boil.BeginTx()](https://godoc.org/github.com/admpub/sqlboiler/boil#BeginTx) 
...
The homepage for the [SQLBoiler](https://github.com/admpub/sqlboiler) [Golang ORM](https://github.com/admpub/sqlboiler)
generator is located at: https://github.com/admpub/sqlboiler

## Benchmarks

If you'd like to run the benchmarks yourself check out our [boilbench](https://github.com/admpub/boilbench) repo.
